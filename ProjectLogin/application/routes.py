...
from application import app, load_data, db
from flask_login import login_user, current_user, login_required
from application.models import User
from application.forms import LoginForm, ShortForm
...
@app.route("/dke/", methods=['GET', 'POST'])
def start():
...
@app.route("/dke/introduction", methods=['GET', 'POST'])
@login_required
def introduction():
    form = LoginForm()
...
@app.route("/dke/questions", methods=['POST', 'GET'])
@login_required
def questions():
    form = ShortForm()
...
@app.route("/dke/end", methods=['GET', 'POST'])
def final():
